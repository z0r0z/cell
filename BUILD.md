...
`firmware/attest.py`. 174 bytes, fits in a QR:

```
magic 4 · version 1 · tier 1 · counter 8 · sighash 32 · fw_hash 32 · pubkey 32 · sig 64
```

Three fields carry the security, and leaving any of them out breaks it:
